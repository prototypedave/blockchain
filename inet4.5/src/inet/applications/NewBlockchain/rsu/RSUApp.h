...
#ifndef __INET4_5_RSUAPP_H_
#define __INET4_5_RSUAPP_H_
 ...
 */
class INET_API RSUApp : public ApplicationBase, public UdpSocket::ICallback
{
  protected:
    UdpSocket socket;
  ...
  protected:
    ...
    // block chain
    void handleAuthenticatorFromVehicle(UdpSocket *socket, Packet *packet);
