...
#ifndef __INET4_5_BLOCKAPP_H_
#define __INET4_5_BLOCKAPP_H_
...
class INET_API BlockApp : public ApplicationBase, public UdpSocket::ICallback
{
  protected:
    UdpSocket socket;
  ...
  protected:
    ...
    void handleTransactionRequest(UdpSocket *socket, Packet *pkt);
};
